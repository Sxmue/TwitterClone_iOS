...
struct AuthService {
    ...
    func registerUser(credentials: AuthCredentials){
        ...
        saveImage(credentials.profileImage, credentials.email, credentials.password, credentials.fullname, credentials.username)
     ...
     */
    func saveImage(_ image: UIImage,_ email:String , _ password: String, _ fullname: String,_ username: String){
        ...
        path.putData(imgData) { metadata,error in
            ...
            path.downloadURL {url, error in
                ...
                saveUser(imageProfileURL, email, password,fullname, username)
     ...
     */
    fileprivate func saveUser(_ image: String,_ email:String , _ password: String, _ fullname: String,_ username: String) {
