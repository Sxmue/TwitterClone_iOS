...
class NotificationsController: UITableViewController {
    ...
    //    func addDeleteListener(){
    //        NotificationService.shared.addDeleteListener{ notifications in
    //
    //            self.notifications = notifications
    //            self.checkFollowNotifications()
    //
    ...
    func didTapOnFollow(_ cell: NotificationCell, indexPath: IndexPath) {
        ...
        if user.isFollowed {
            ...
            UserService.shared.unfollowUser(uid: user.uid) { _, _ in
                ...
                NotificationService.shared.deleteFollowNotification(toUser: user.uid) { error, ref in
                }
            ...
            UserService.shared.followUser(uid: user.uid) { _, _ in
                ...
                NotificationService.shared.uploadNotification(user: user, type: .follow)
